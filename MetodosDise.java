                ...
                try {
                    ...
                    if (CantAsignaturas >= 0 && CantAsignaturas <= 10) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Error: Las cantidades de aignaturas debe estar entre 0 y 10");
                    }
                } catch (NumberFormatException e) {
                    JOptionPane.showMessageDialog(null,
                            "Error: Ingrese un número válido para la cantidad de asignaturas.");
                }
            }
    ...
    public String Buscar(LinkedList<Estudiante> lista, LinkedList<Dispositivo> lista2, String serialBuscar) {
        ...
        for (Dispositivo disp : lista2) {
            ...
            for (Estudiante est : lista) {
                EstDiseño e = (EstDiseño) est;
                do {
                    if (disp.getSerial().equalsIgnoreCase(serialBuscar)
                        ...
                        mensaje = "\t El equipo que se busco es \t\n" +
                                ...
                                est.MostrarMaestroE() +
                                "Semestre actual: " + e.getModEstudio() + "\n" +
                                "Promedio acomulado: " + e.getCantAsignaturas() + "\n";
                ...
                } while (serialBuscar == tab.getSerial());
    ...
    public LinkedList<Estudiante> Modificar(String buscarSerial, LinkedList<Dispositivo> lista,
        ...
        for (Estudiante est : lista2) {
            ...
            for (Dispositivo disp : lista) {
                ...
                } while (buscarSerial == tab.getSerial());
            }
