...
public class EstudianteIngeniería {
    ...
    public EstudianteIngeniería(String cedula, String nombre, String apellido, String telefono, int numeroSemestre, float promedioAcumulado, String serial) {
        setCedula(cedula);
        setNombre(nombre);
